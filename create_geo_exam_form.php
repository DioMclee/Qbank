...
<head>
  <meta charset="UTF-8">
  <title>Select Geography Questions</title>
  <style>
    body {
...
<body>
  <div class="container">
    <h2>Geography Exam</h2>
    <form action="generate_geo_questions.php" method="post">
      <div class="form-group">
        <div class="question-type">
          ...
          $sql = "SELECT DISTINCT topic FROM geography_questions";
          ...
          if ($result->num_rows > 0) {
            while ($row = $result->fetch_assoc()) {
              ...
              $question_types = ['Essay', 'True/False', 'Short'];
              foreach ($question_types as $question_type) {
                ...
                echo "<input type='number' name='easy_questions[$question_type][$topic]' min='0'>";
                echo "<label for='topic_{$question_type}_{$topic}_medium_questions'>Medium Qns:</label>";
                echo "<input type='number' name='medium_questions[$question_type][$topic]' min='0'>";
                echo "<label for='topic_{$question_type}_{$topic}_hard_questions'>Hard Qns:</label>";
                echo "<input type='number' name='hard_questions[$question_type][$topic]' min='0'>";
                echo "</div>";
                echo "</div>";
              }
